...
$$\begin{aligned}{_B^AR^T}{_B^AR}&=\begin{bmatrix}{_X^A\hat{X}_B}&{_Y^A\hat{Y}_B}&{_Z^A\hat{Z}_B}\end{bmatrix}^T\begin{bmatrix}{_X^A\hat{X}_B}&{_Y^A\hat{Y}_B}&{_Z^A\hat{Z}_B}\end{bmatrix}\\    &=I_3\end{aligned}
$$
