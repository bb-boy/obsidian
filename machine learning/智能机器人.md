...
5. **Rotation by Fixed angles**
	...
	![[Pasted image 20250317084536.png]]
...
1. **Homogeneous transformation matrix**
	...
	$$[\begin{matrix}{_B^AR_{3\times3}}&{^{A}P_{Borg}}\\{\begin{array}{ccc}{0}&{0}&{0}\end{array}}&{1}\end{matrix}]$$$$
= \begin{bmatrix}
^A \hat{X}_B & ^A \hat{Y}_B & ^A \hat{Z}_B & ^AP _B \, org \\
0 & 0 & 0 & 1
\end{bmatrix}=_B^AT
$$
	**验证该矩阵**
	- 仅有移动$${}^AP_{_{3\times1}}={}^BP_{_{3\times1}}+{}^AP_{_{Borg}}$$
